            ...
            for n_direc in direcs:
                ...
                if 0<=n_r<num_r and 0<=n_c<num_c:
                    ...
                    if direc == n_direc:
                        ...
                        if (n_r, n_c, n_direc, 2) not in visited:
                            visited.add((n_r, n_c, n_direc, 2))
                            heappush(heap, (n_cost, n_r, n_c, n_direc, 2))
